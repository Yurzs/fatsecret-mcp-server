 ...
 */
export function dateToFatSecretInt(date) {
 ...
 */
export function dateStringToFatSecretInt(dateStr) {
 ...
 */
export function fatSecretIntToDateString(dateInt) {
 ...
 */
export function todayAsFatSecretInt() {
    return dateToFatSecretInt(new Date());
}
export const VALID_MEALS = ["breakfast", "lunch", "dinner", "other"];
